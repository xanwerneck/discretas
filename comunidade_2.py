...
# Entrada              - o array montado a partir do arquivo lido
...
#                              ocorrencia no parametro comb, se sim OK, foi encontrado o array buscado, do #                              contrario continua procurando
